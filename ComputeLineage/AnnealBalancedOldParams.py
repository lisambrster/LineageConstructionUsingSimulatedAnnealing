...
print('Balanced Old Weights ',solWt,angWt,symWt,meanIWt,stdIWt,   centWt,centNoSplitWt,centSplitMDWt,centSplitDDWt,17,33, volWt,volNoSplitWt,volSplitWt,volNoSplitMult,volSplitMult,splitWt)
